 ...
 *     },
 * }
 * @psalm-type ErrorWatchConfig = array{
 *     enabled?: scalar|Param|null, // Enable/disable ErrorWatch. Accepts bool or env var (e.g. %env(bool:ERRORWATCH_ENABLED)%). // Default: false
 *     endpoint?: scalar|Param|null, // ErrorWatch API endpoint URL // Default: ""
 *     api_key?: scalar|Param|null, // ErrorWatch API key // Default: ""
 *     environment?: scalar|Param|null, // Environment name (defaults to kernel.environment) // Default: ""
 *     release?: scalar|Param|null, // Release version (e.g., "1.2.3"). Auto-detects from git if not set. // Default: null
 *     replay?: array{
 *         enabled?: bool|Param, // Default: false
 *         debug?: bool|Param, // Enable verbose console logging for replay debugging // Default: false
 *         sample_rate?: float|Param, // Default: 0.1
 *     },
 *     breadcrumbs?: array{
 *         enabled?: bool|Param, // Enable automatic breadcrumb collection // Default: true
 *         max_count?: int|Param, // Maximum number of breadcrumbs to keep // Default: 100
 *     },
 *     user_context?: array{
 *         enabled?: bool|Param, // Enable user context capture for error attribution // Default: true
 *         capture_ip?: bool|Param, // Capture IP address in user context // Default: true
 *     },
 *     console?: array{
 *         enabled?: bool|Param, // Default: true
 *         capture_exit_codes?: bool|Param, // Capture non-zero exit codes even without exceptions // Default: true
 *     },
 *     messenger?: array{
 *         enabled?: bool|Param, // Default: true
 *         capture_retries?: bool|Param, // Also capture failures that will be retried (noisy) // Default: false
 *     },
 *     deprecations?: array{
 *         enabled?: bool|Param, // Capture PHP deprecations (opt-in, can be noisy) // Default: false
 *     },
 *     security?: array{
 *         enabled?: bool|Param, // Default: true
 *         capture_login_success?: bool|Param, // Add breadcrumbs for successful logins // Default: false
 *     },
 *     apm?: array{
 *         enabled?: bool|Param, // Default: true
 *         request_tracking?: bool|Param, // Default: true
 *         doctrine?: array{
 *             enabled?: bool|Param, // Default: true
 *             log_queries?: bool|Param, // Log sanitized SQL in span descriptions // Default: true
 *         },
 *         http_client?: array{
 *             enabled?: bool|Param, // Default: true
 *             capture_errors_as_breadcrumbs?: bool|Param, // Default: true
 *         },
 *         cache?: array{
 *             enabled?: bool|Param, // Emit cache.get / cache.delete spans on the Symfony cache adapter // Default: true
 *         },
 *         n_plus_one_threshold?: int|Param, // Minimum repeated query count to flag as N+1 // Default: 5
 *         slow_query_threshold_ms?: int|Param, // Query duration threshold in ms to flag as slow // Default: 500
 *         excluded_routes?: list<scalar|Param|null>,
 *     },
 *     monolog?: array{
 *         enabled?: bool|Param, // Enable automatic Monolog forwarding to ErrorWatch // Default: true
 *         level?: "debug"|"info"|"notice"|"warning"|"error"|"critical"|"alert"|"emergency"|Param, // Default: "warning"
 *         excluded_channels?: list<scalar|Param|null>,
 ...
 *         excluded_channels?: list<scalar|Param|null>,
 *         capture_context?: bool|Param, // Include Monolog context in live logs payload // Default: true
 *         capture_extra?: bool|Param, // Include Monolog extra data in live logs payload // Default: true
 *     },
 * }
